...
```
This object can then be used to compute the topological properties of the KG. For example, to compute the edge patterns of the KG, we can use the `edge_pattern_summary` method:
...
If you would prefer to consider the properties at the level of relations, you can use the `aggregate_by_relation` method:
